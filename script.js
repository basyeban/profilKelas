/*
  ...
  (Tanpa tombol tambah foto & edit + IG clickable + tanpa tanggal lahir)
*/
...
const defaultStudents = [
  ...
  { id: 2, name: 'AKBAR WAHYU FEBRIYANTO', nickname: 'Akbar', birthDate: '2007-02-10', username: 'akbrwahy._', motivation: 'tiada hidup tanpa masalah, tiada perjuangan tanpa rasa lelah, tetap semangatlah sampai bismillah mu menjadi alhamdulillah', photo: '' },
...
/* ---------- Card Creation (IG clickable + tanpa tanggal lahir) ---------- */
...
function toggleStudentList() {
  showGrid = !showGrid;
  studentGrid.classList.toggle('hidden', !showGrid);
...
function openInstagram() {
    // Ganti "kelas25a3" dengan username Instagram kelas kamu
